package com.thucchien02.bookservice.config;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Book API specification - thucchien02",
                description = "API docs for Book service",
                version = "1.0",
                contact = @Contact(
        ...
        servers = {
                ...
                @Server(
                        description = "Dev env",
                        url = "https://book-service.dev.test.com"
                )
        }
)
